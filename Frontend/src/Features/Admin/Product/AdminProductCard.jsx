...
export function AdminProductCard({
  ...
  return (
    <div
      className={`text-black p-2 border-2 border-[#E5E7EB] border-solid box-border ${className} flex flex-col justify-between h-full `}
    >
      ...
      {
        <div className="h-[5%] text-sm font-semibold text-red-600">
          {deleted ? "deleted" : ""}
        </div>
      }
    </div>
