...
// console.log({selectedProduct})
  ...
  return (
    <div className="wrapper flex flex-col gap-10">
      ...
      {selectedProduct.status === 'loading' && <p className="text-2xl font-semibold ">Loading ...</p>}
     ...
     { selectedProduct && selectedProduct.product && 
      ...
      <div className="highlights px-5 w-[90vw] mx-auto">
        <span className="text-2xl font-bold">Higlights:</span>
        <ol className="list-disc mt-5">
          <li>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatem
            quos reprehenderit dignissimos fugit itaque culpa earum quas iure in
            quo, fuga, aliquid
          </li>
          <li>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatem
