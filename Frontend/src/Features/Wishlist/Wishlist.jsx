...
import { selectWishlistItems, fetchAllWishlistItemsAsync } from "./WishlistSlice";
import { removeFromWishlistAsync } from "./WishlistSlice";
...
export function WishlistItemCard({_id, className, thumbnail, title, brand, discountPercentage, stock, price, deleted}) {
  const dispatch = useDispatch();
